...
{
    /// <summary>A queue's wait cleared below its threshold. Spec: 10-events.md §10.9.</summary>
    public readonly struct QueueThresholdCleared : ISimEvent
    {
        ...
        public QueueThresholdCleared(NodeId node, Fx waitMinutes, int serversOpen, int serverCount)
        {
            Node = node;
