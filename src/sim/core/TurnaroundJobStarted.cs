...
{
    /// <summary>A turnaround job started. Spec: 10-events.md §10.9.</summary>
    public readonly struct TurnaroundJobStarted : ISimEvent
    {
        ...
        public TurnaroundJobStarted(FlightId flight, JobKind job, ulong plannedStart)
        {
            Flight = flight;
            Job = job;
